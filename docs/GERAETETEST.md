...
|---|---|---|---|---|---|
| 0.1 | QR-Code scannen, Expo Go öffnet das Projekt | Startbild Karmin-Büchlein auf Kiesel, danach der Erststart; keine rote Fehlermeldung | | | |
| 0.2 | Erststart ansehen | Stempel-Marke in Karmin mit dem heutigen Datum, Titel «Alles zu deinem Hund griffbereit – und rechtzeitig erinnert.», Hinweis zur Tiermedizin; Schrift Atkinson (durchgestrichene Null in «2026») | | | |
